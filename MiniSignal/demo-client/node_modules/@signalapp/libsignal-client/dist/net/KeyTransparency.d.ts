...
export interface Client {
     ...
     */
    check: (request: Request, store: Store, options?: Readonly<Options>) => Promise<void>;
}
/**
 ...
 */
export declare enum AccountDataField {
    E164 = 0,
    UsernameHash = 1
}
/**
 ...
 */
export declare function resetField(aci: Aci, field: AccountDataField, store: Store): Promise<void>;
