...
export class PinHash {
     ...
     */
    static fromSalt(normalizedPin, salt) {
     ...
     */
    static fromUsernameMrenclave(normalizedPin, username, mrenclave) {
...
export const Pin = {
     ...
     */
    verifyLocalHash(encodedHash, normalizedPin) {
